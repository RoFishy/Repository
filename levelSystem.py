...
class LevelSystem(commands.Cog):
    ...
    async def save(self):
        ...
        while not self.client.is_closed():
            with open("Galaxy Games Bot/cogs/jsonfiles/users.json", "w", encoding="utf-8") as f:
    ...
    async def on_message(self, message):
        ...
        if self.level_up(author_id):
            ...
            level_up_embed.add_field(name="Congratulations", value=f"{message.author.mention} has just level uped to level {self.users[author_id]['Level']}!")
